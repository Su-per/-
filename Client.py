        ...
        while True:
            ...
            if turn == 2:
                ...
                for i in range(0,15,1):
                    ...
                    print(" ")
                textcolor(15,0)
                x = receive2(clientSock)
                send(clientSock, trash)
                y = receive2(clientSock)
                map[y][x] = 2
                turn -= 1
    if bw == 2:
        while(True):
            ...
            if turn == 2:
                ...
                map[y][x] = 2
                send2(clientSock, str(x))
                trash = receive(clientSock)
                send2(clientSock, str(y))
                turn -= 1
